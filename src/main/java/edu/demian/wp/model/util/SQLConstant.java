...
public interface SQLConstant {
    ...
    String SQL_FIND_ALL_EXPOSITIONS = "SELECT * FROM exposition";
    ...
    String SQL_FIND_EXPOSITION_BY_TOPIC = "SELECT * FROM exposition WHERE topic ILIKE ?";
    String SQL_FIND_EXPOSITION_BY_TOPIC_AND_CATEGORY = "SELECT * FROM exposition WHERE topic ILIKE ? AND exposition_category=?";
    String SQL_FIND_EXPOSITION_BY_CATEGORY = "SELECT * FROM exposition WHERE exposition_category=?";
